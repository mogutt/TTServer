...
public class PBRouter {
	...
	public static PBRouter instance;
	
	// 路由的配置信息
	private Map<Integer, ActionDescricptor> actionMap = new HashMap<Integer, ActionDescricptor>();
	
	public static PBRouter getInstance() {
		if(instance == null) {
			instance = new PBRouter();
		}
	...
	public void load(String file) throws Exception {
		...
		InputStream is = PBRouter.class.getClassLoader().getResourceAsStream(file);
		if(is == null) {
